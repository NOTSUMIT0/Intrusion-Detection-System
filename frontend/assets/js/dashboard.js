...
function openModal(alert) {
  ...
  content.innerHTML = `
    <div class="space-y-3">
      ...
      <div class="bg-[#111827] p-4 rounded border border-gray-800">
        <p class="font-semibold mb-1 text-cyan-400">
          Why was this detected?
        </p>
        <p class="text-gray-400">
          This alert was generated due to abnormal traffic behavior
          matching IDS detection rules and statistical thresholds.
        </p>
      </div>

      <div class="bg-[#111827] p-4 rounded border border-gray-800">
        <p class="font-semibold mb-1 text-green-400">
          Recommended Actions
        </p>
        <ul class="list-disc list-inside text-gray-400 space-y-1">
          <li>Investigate source IP activity</li>
          <li>Apply firewall or rate-limiting rules</li>
          <li>Review logs for lateral movement</li>
